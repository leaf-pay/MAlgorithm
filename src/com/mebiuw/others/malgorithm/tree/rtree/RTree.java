package com.mebiuw.others.malgorithm.tree.rtree;
...
import com.mebiuw.others.malgorithm.tree.rtree.Constants;
...
//			System.out.println(rectangles[i]);
		...
		BufferedReader reader = new BufferedReader(new FileReader(new File("G:\\RTree.txt")));
		String line ;
		...
		reader = new BufferedReader(new FileReader(new File("G:\\RTree.txt")));
		while((line = reader.readLine()) != null)
		{
			String[] splits = line.split(" ");
			float lx = Float.parseFloat(splits[1]);
